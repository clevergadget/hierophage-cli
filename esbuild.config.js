...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('hierophage.js build failed:', cliResult.reason);
    process.exit(1);
  }
  // error in a2a-server bundling will not stop hierophage.js bundling process
